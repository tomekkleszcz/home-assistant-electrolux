...
class PM1Sensor(ElectroluxApplianceEntity, SensorEntity):
    livestream_properties = frozenset({"PM1"})
    ...
    def __init__(self, hub: ElectroluxHub, appliance: Appliance, info: ApplianceInfo, appliance_state: ApplianceState):
        ...
        self._attr_unique_id = f"electrolux_pm1_{appliance.id}"
        self._attr_name = f"{appliance.name} PM1"
    ...
    def _update_attributes(self):
        ...
        self._attr_native_value = reported.pm_1
