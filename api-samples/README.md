...
| `950011605` | Electrolux | COMFORT600 | AZULTM06 | Matt Silver | Portable air conditioner | Sanitized API capture | [`capabilities.json`](950011605/capabilities.json), [`state.json`](950011605/state.json) |
